    ...
    <div className="flex flex-col w-full overflow-x-hidden">
      <section className="relative h-[90vh] sm:h-screen w-full flex items-center justify-center bg-[#F8F5F0] overflow-hidden -mt-24">
        ...
        <motion.div
          ...
          className="absolute inset-0 z-0 bg-center bg-no-repeat filter blur-[1px] bg-[length:65%_auto] sm:bg-[length:75%_auto] md:bg-[length:85%_auto] lg:bg-[length:95%_auto]"
          style={{
