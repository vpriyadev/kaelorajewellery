        ...
        {toasts.map((toast) => {
          ...
          return (
            <motion.div
              ...
              layout
              className={`flex items-start gap-3 p-4 rounded-xl border shadow-xl backdrop-blur-md transition-all duration-300 ${
                isReward
                  ? 'bg-[#1A1A1A]/95 text-[#EDE6DA] border-[#D4AF37]/50 shadow-[#D4AF37]/10'
                  : toast.type === 'success'
                  ? 'bg-white/95 text-[#1A1A1A] border-[#EDE6DA] shadow-gray-200/50'
                  : toast.type === 'error'
            ...
            >
              ...
              <div className="flex-1">
                {isReward && (
                  <p className="text-xs uppercase tracking-widest text-[#D4AF37] font-semibold mb-0.5">
